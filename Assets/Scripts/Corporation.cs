...
public class Corporation
{
    ...
    public List<StockData> corporation;

    public Corporation()
    {
        corporation = new List<StockData>(JsonManager.Instance.JsonData.response.body.items.item.Count);
        ...
        foreach (var item in JsonManager.Instance.JsonData.response.body.items.item)
        {
            ...
            corporation.Add(new StockData(versus, marketPrice, closingPrice, highPrice, lowPrice));
        }
    }
}
